package OpenMRS_Project;
  ...
  import static Utility.BaseDriver.driver;
    ...
    public class Asli_POM{
        ...
        @FindBy(xpath="//li[@id='InpatientWard']")
        ...
        @FindBy(css="[placeholder='SearchbyIDorName']")
        public WebElement hastaArama;

        @FindBy(css="[class='col-12col-sm-12col-md-12col-lg-12']")
        ...
        @FindBy(linkText="FindPatientRecord")
